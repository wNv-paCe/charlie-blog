...
export default function AboutPage() {
  return (
    <div className="flex min-h-screen flex-col">
      <Header />
      <main className="mx-16 flex flex-1 border-b border-gray-500 py-8">
          ...
          <section className="mt-8 space-y-6 p-4">
            ...
            <div className="p-4">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">
                Welcome to my personal blog. I use this space to share my
            ...
            <div className="p-4">
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">
                This blog is where I document my learning journey, technical
                notes, and personal projects.
              </p>
            </div>
